...
require_once('form/enrolment_present_form.php');
...
$PAGE->set_url('/local/accesscohort/enrolment_present.php');
...
$previewnode = $previewnode->add($title, new moodle_url($CFG->wwwroot.'/local/accesscohort/accesscohort_enrol.php'));

//$thingnode->make_active();

echo $OUTPUT->header();
$mform = new local_enrolment_present_form(null,array('csdata'=>$_POST));
if(is_siteadmin()){
$mform->display();
}else{
