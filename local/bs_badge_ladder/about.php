...
$params = array('aboutlink' => html_writer::link('https://moodle.org/plugins/local_bs_badge_ladder',
    get_string('plugindirectory', 'local_bs_badge_ladder'), array('target' => '_blank')),
