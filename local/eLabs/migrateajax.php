...
if($pname != null){
	...
	$content .= '<div class="col-md-3">
			    ...
			    <div class="col-md-9 form-inline felement" data-fieldtype="select">
			        <select class="custom-select" name="mb_stream" id="id_streams">
	...
	$content .= '<div class="col-md-3">
			    ...
			    <div class="col-md-9 form-inline felement" data-fieldtype="select">
			        <select class="custom-select" name="mb_semester_year" id="id_syears">
	...
	$content .= '<div class="col-md-3">
			    ...
			    <div class="col-md-9 form-inline felement" data-fieldtype="select">
			        <select class="custom-select" name="mb_semester" id="id_semesters">
	...
	$content .= '<div class="col-md-3">
			    ...
			    <div class="col-md-9 form-inline felement" data-fieldtype="select">
			        <select class="custom-select" name="mb_batchname" id="id_batches">
			            <option value="" disabled="" selected="">Select Batch</option>';
			            foreach ($batches as $bat) {
							$content .= '<option value="'.$bat->id.'">'.$bat->batchname.'</option>';
						} 
	$content .= '</select>
			        <div class="form-control-feedback" id="id_error_mb_batchname" style="display: none;">
			        </div>
			    </div>';
}
// elseif($courseid != 0){
