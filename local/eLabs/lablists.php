...
<script type="text/javascript">
    ...
    function view_acadlab_assigned(id){
        $.ajax({
            url: 'stulistajax.php',
            dataType: 'json',
            type: 'get',
...
echo $OUTPUT->header();
prof_elabs_requestlist();
//Academic button click views
echo '<div class="modal fade" id="acad_assignedBatch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel66" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content modal-responsive">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel66">Academic Lab Assigned Batch </h4>
