@javascript @block_quickmailsms_groups_feature
Feature: Control student use of QuickmailSMS in courses in accordance with FERPA constraints. 
    ...
    Scenario: Teacher sees all
        Given I log in as "teacher1"
        And I follow "Course 1"
        When I click on "Compose New Email" "link" in the "QuickmailSMS" "block"
