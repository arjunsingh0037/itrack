@block @block_quickmailsms
Feature: Verify Admin behavior for QuickmailSMS
  ...
  Background:
    ...
    And I add the "QuickmailSMS" block
    Then I should see "Send Admin Email" in the "QuickmailSMS" "block"
    And I am on homepage
