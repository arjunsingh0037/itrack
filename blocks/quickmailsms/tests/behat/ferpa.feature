@block @block_quickmailsms @ferpa @javascript
Feature: Ensure enrollee visibility behaves in accordance with ferpa settings.




#/var/www/jpeak5.mdl/blocks/quickmailsms/tests/behat/ferpa.feature
...
# the possible configurations for quickmailsms. Given 2 administrative settings with 3 options each, and 2 block-level
...
# NB: Because of the additional complexity, the /var/www/jpeak5.mdl/blocks/quickmailsms/tests/behat/ferpa.feature test does not account for the groups filter.
...
#        |s5|s5|student|
    ...
    Given I log in as "t4"
        ...
        And I should see "Compose New Email" in the "QuickmailSMS" "block"
        And I log out

# Configuration details:
# Allow students to use QuickmailSMS [global]: Yes
# Allow students to use QuickmailSMS [course]: Yes
...
# Configuration details:
# Allow students to use QuickmailSMS [global]: Yes
# Allow students to use QuickmailSMS [course]: not set
# FERPA Mode: Always Separate Groups
# Course group mode: ignored
...
# Configuration details:
# Allow students to use QuickmailSMS [global]: not set
# Allow students to use QuickmailSMS [course]: Yes
# FERPA Mode: Always Separate Groups
# Course group mode: ignored
...
# Configuration details:
# Allow students to use QuickmailSMS [global]: Never
# Allow students to use QuickmailSMS [course]: ignored
# FERPA Mode: Always Separate Groups
# Course group mode: ignored
