...
namespace block_quickmailsms\event;
...
class alternate_email_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventalternateemailadded', 'block_quickmailsms');
    }
    ...
    public function get_url() {
        return new \moodle_url('/blocks/quickmailsms/alternate.php', array(
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'quickmailsms', 'add', $this->get_url(),
            get_string('alternate', 'block_quickmailsms') . ' ' . $this->other['address']);
    }
}