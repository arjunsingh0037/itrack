(function(){
  ...
  $(document).ready(function() {
    var clear_selections, mailed, move, potentials, quickmailsms_changer, selectors;
    ...
    $("#groups").change(quickmailsms_changer);
    $("#roles").change(quickmailsms_changer);
