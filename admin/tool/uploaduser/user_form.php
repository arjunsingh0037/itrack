...
class admin_uploaduser_form2 extends moodleform {
    function definition () {
        ...
        $mform->addElement('header', 'settingsheader2', get_string('settings'));
        ...
        $mform->addElement('hidden', 'usertype','', 'maxlength="255" size="25"');
        $mform->setType('usertype', PARAM_RAW);
        $mform->setDefault('usertype', $data['usertype']);

        $mform->addElement('hidden', 'program','', 'maxlength="255" size="25"');
        $mform->setType('program', PARAM_RAW);
        $mform->setDefault('program', $data['program']);

        $mform->addElement('hidden', 'stream','', 'maxlength="255" size="25"');
        $mform->setType('stream', PARAM_RAW);
        $mform->setDefault('stream', $data['stream']);

        $mform->addElement('hidden', 'semester','', 'maxlength="255" size="25"');
        $mform->setType('semester', PARAM_RAW);
        $mform->setDefault('semester', $data['semester']);

        $mform->addElement('hidden', 'semyear','', 'maxlength="255" size="25"');
        $mform->setType('semyear', PARAM_RAW);
        $mform->setDefault('semyear', $data['semyear']);
