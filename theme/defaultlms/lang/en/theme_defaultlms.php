...
/* Core */
$string['configtitle'] = 'defaultlms';
$string['pluginname'] = 'defaultlms';
$string['choosereadme'] = '
<div class="clearfix">
<div style="margin-bottom:20px;">
<p style="text-align:center;"><img class="img-polaroid" src="defaultlms/pix/screenshot.jpg" /></p>
</div>
<hr />
<div class="prom-box prom-box-default shadow2" style="margin-bottom:20px;">
<h2>Theme defaultlms - Responsive Theme for Moodle</h2>
</div>
<h4>Theme Summary</h4>
...
<hr />
<p style="text-align:center;"><img class="img-polaroid" src="defaultlms/pix/redPIthemes.jpg" /></p>';
