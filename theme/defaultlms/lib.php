...
function theme_defaultlms_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('defaultlms');		
		if ($filearea === 'logo') {
...
function defaultlms_set_pagewidth1($css, $pagewidth) {
...
function defaultlms_set_pagewidth2($css, $pagewidth) {
...
function theme_defaultlms_set_fontsrc($css) {
    $tag = '[[setting:fontsrc]]';
	$themewww = $CFG->wwwroot."/theme";
    $css = str_replace($tag, $themewww.'/defaultlms/fonts/', $css);
    return $css;
}

function defaultlms_set_customcss($css, $customcss) {
...
function theme_defaultlms_process_css($css, $theme) {
    ...
    $css = defaultlms_set_pagewidth1($css,$pagewidth);
	$css = defaultlms_set_pagewidth2($css,$pagewidth);  
    // Set the Fonts.
    ...
    $css = theme_defaultlms_set_headingfont($css, $headingfont);
    $css = theme_defaultlms_set_bodyfont($css, $bodyfont);
    ...
    $css = defaultlms_set_customcss($css, $customcss);
    ...
    $css = theme_defaultlms_set_maincolor($css, $maincolor);
    ...
    $css = theme_defaultlms_set_mainhovercolor($css, $mainhovercolor);
    ...
    $css = theme_defaultlms_set_linkcolor($css, $linkcolor);
    ...
    $css = theme_defaultlms_set_def_buttoncolor($css, $def_buttoncolor);
    ...
    $css = theme_defaultlms_set_def_buttonhovercolor($css, $def_buttonhovercolor);
    ...
    $css = theme_defaultlms_set_menufirstlevelcolor($css, $menufirstlevelcolor);
    ...
    $css = theme_defaultlms_set_menufirstlevel_linkcolor($css, $menufirstlevel_linkcolor);
    ...
    $css = theme_defaultlms_set_menusecondlevelcolor($css, $menusecondlevelcolor);
    ...
    $css = theme_defaultlms_set_menusecondlevel_linkcolor($css, $menusecondlevel_linkcolor);
    ...
    $css = theme_defaultlms_set_footercolor($css, $footercolor);
    ...
    $css = theme_defaultlms_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_defaultlms_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_defaultlms_set_copyrightcolor($css, $copyrightcolor);
	...
	$css = theme_defaultlms_set_copyright_textcolor($css, $copyright_textcolor);
    ...
    $css = theme_defaultlms_set_socials_color($css, $socials_color);
	...
	if (is_null($theme->setting_file_url('pagebackground', 'pagebackground'))) {
		...
		if ($theme->settings->list_bg==1)  {
			...
			$repeat = 'no-repeat fixed 0 0';
			$size = 'cover';}
		$css = theme_defaultlms_set_pagebackground($css, $pagebackground, $setting);
		$css = theme_defaultlms_set_background_repeat($css, $repeat, $size);
    }
	...
	$css = theme_defaultlms_set_fontsrc($css);
	
    return $css;
}

function theme_defaultlms_set_headingfont($css, $headingfont) {
...
function theme_defaultlms_set_bodyfont($css, $bodyfont) {
...
function theme_defaultlms_set_maincolor($css, $themecolor) {
...
function theme_defaultlms_set_mainhovercolor($css, $themecolor) {
...
function theme_defaultlms_set_linkcolor($css, $themecolor) {
...
function theme_defaultlms_set_def_buttoncolor($css, $themecolor) {
...
function theme_defaultlms_set_def_buttonhovercolor($css, $themecolor) {
...
function theme_defaultlms_set_menufirstlevelcolor($css, $themecolor) {
...
function theme_defaultlms_set_menufirstlevel_linkcolor($css, $themecolor) {
...
function theme_defaultlms_set_menusecondlevelcolor($css, $themecolor) {
...
function theme_defaultlms_set_menusecondlevel_linkcolor($css, $themecolor) {
...
function theme_defaultlms_set_footercolor($css, $themecolor) {
...
function theme_defaultlms_set_footerheadingcolor($css, $themecolor) {
...
function theme_defaultlms_set_footertextcolor($css, $themecolor) {
...
function theme_defaultlms_set_copyrightcolor($css, $themecolor) {
...
function theme_defaultlms_set_copyright_textcolor($css, $themecolor) {
...
function theme_defaultlms_set_socials_color($css, $themecolor) {
...
function theme_defaultlms_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_defaultlms_set_background_repeat($css, $repeat, $size) {
...
function theme_defaultlms_page_init(moodle_page $page) {
    $page->requires->jquery();
	$page->requires->jquery_plugin('jquery.easing.1.3', 'theme_defaultlms'); 
	$page->requires->jquery_plugin('camera_slider', 'theme_defaultlms');
    $page->requires->jquery_plugin('jquery.bxslider', 'theme_defaultlms'); 
    $page->requires->jquery_plugin('jquery.slimscroll', 'theme_defaultlms'); 
}
