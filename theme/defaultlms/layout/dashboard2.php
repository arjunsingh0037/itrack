...
<head>
    ...
    ?>
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/bs3/css/bootstrap.min.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery-ui/jquery-ui-1.10.1.custom.min.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/css/bootstrap-reset.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/font-awesome/css/font-awesome.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jvector-map/jquery-jvectormap-1.2.2.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/css/clndr.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/css3clock/css/style.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/morris-chart/morris.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/css/style.css'?>"> 
   <link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/css/style-responsive.css'?>"> 
</head>
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/chat-user-thumb.png'?>" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/chat-user-thumb-f.png'?>" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/weather_image.jpg'?>" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/avatar1_small.jpg'?>" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/avatar1.jpg'?>" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="<?php echo $CFG->wwwroot.'/theme/defaultlms/images/chat-avatar2.jpg'?>" alt=""></a>
                </div>
                <div class="user-details">
...
<!--Core js-->
<link rel="stylesheet" href="<?php echo $CFG->wwwroot.'/theme/defaultlms/css/style-responsive.css'?>"> 
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery-ui/jquery-ui-1.10.1.custom.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/bs3/js/bootstrap.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.dcjqaccordion.2.7.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.scrollTo.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.nicescroll.js'?>"></script>

<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/skycons/skycons.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.scrollTo/jquery.scrollTo.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.easing.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/calendar/clndr.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/underscore-min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/calendar/moment-2.2.1.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/evnt.calendar.init.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jvector-map/jquery-jvectormap-1.2.2.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jvector-map/jquery-jvectormap-us-lcc-en.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/gauge/gauge.js'?>"></script>
<!--clock init-->
<script src"<?php echo $CFG->wwwroot.'/theme/defaultlms/js/css3clock/js/css3clock.js'?>"></script>
<!--Easy Pie Chart-->
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/easypiechart/jquery.easypiechart.js'?>"></script>
<!--Sparkline Chart-->
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/sparkline/jquery.sparkline.js'?>"></script>
<!--Morris Chart-->
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/morris-chart/morris.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/morris-chart/raphael-min.js'?>"></script>
<!--jQuery Flot Chart-->
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.tooltip.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.resize.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.pie.resize.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.animator.min.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/flot-chart/jquery.flot.growraf.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/dashboard.js'?>"></script>
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/jquery.customSelect.min.js'?>" ></script>
<!--common script init for all pages-->
<script src="<?php echo $CFG->wwwroot.'/theme/defaultlms/js/scripts.js'?>"></script>
