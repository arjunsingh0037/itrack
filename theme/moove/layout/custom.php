...
$templatecontext['username'] = $USER->firstname;
$templatecontext['dashboardlink'] = $CFG->wwwroot.'/my';  
$templatecontext['userprofilelink'] = $CFG->wwwroot.'/user/profile.php?id='.$USER->id;  
$templatecontext['courseview'] = $CFG->wwwroot.'/course';

$templatecontext['flatnavigation'] = $PAGE->flatnav;

//require_once(dirname(__FILE__).'/includes/jslinks.php');
echo $OUTPUT->render_from_template('theme_moove/custom', $templatecontext);
