...
/* Core */
$string['configtitle'] = 'itrackglobal';
$string['pluginname'] = 'itrackglobal';
$string['choosereadme'] = '
<div class="clearfix">
<div style="margin-bottom:20px;">
<p style="text-align:center;"><img class="img-polaroid" src="itrackglobal/pix/screenshot.jpg" /></p>
</div>
<hr />
<div class="prom-box prom-box-default shadow2" style="margin-bottom:20px;">
<h2>Theme itrackglobal - Responsive Theme for Moodle</h2>
</div>
<h4>Theme Summary</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibility: Moodle 2.5/2.6/2.7/2.8/2.9<br />Theme Version: 1.42<br />Parent theme: Bootstrapbase by Bas navbar-brands<br />Built on: Essential by Julian Ridden</p>
</div>
<hr />
<p style="text-align:center;"><img class="img-polaroid" src="itrackglobal/pix/redPIthemes.jpg" /></p>';
...
$string['socialsdesc'] = 'Provide direct links to the core social networks that promote your navbar-brand.';
...
$string['scormupdate'] = 'Update Scorm Status';
