...
<h2>Tema defaultlms - Tema responsive para Moodle</h2>
</div>
<h4>Caracter&iacute;sticas del tema</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibilidad: Moodle 2.5/2.6/2.7/2.8/2.9<br />Versi&oacute;n del tema: 1.42<br />Tema matriz: Bootstrapbase de Bas navbar-brands<br />Basado en: Essential de Julian Ridden</p>
</div>
<hr />
