...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/defaultlms/style/nojs.css" />
	</noscript>
    <!-- Google web fonts -->
...
<div class="text-center" style="line-height:1em;">
	<img src="<?php echo $CFG->wwwroot;?>/theme/defaultlms/pix/bg/shadow.png" class="slidershadow frontpage-shadow" alt="">
</div>
...
<?php require_once(dirname(__FILE__).'/includes/slideshow.php');?>
    ...
    <div id="page-content" class="row">
        ...
        <?php } ?>
        	...
        	if ($hasfrontpageblocks==1) { 
				if ($standardlayout) {echo $OUTPUT->blocks('side-pre', 'col-md-4 desktop-first-column pull-left');}
				else {echo $OUTPUT->blocks('side-pre', 'col-md-4 desktop-first-column pull-right');}
			} ?>
            </div>
        	</div>
	...
	<div class="hidden-blocks">
    	<div class="row">
        	<h4><?php echo get_string('visibleadminonly', 'theme_defaultlms') ?></h4>
            <?php
	...
	<a href="#top" class="back-to-top"><i class="fa fa-chevron-circle-up fa-3x"></i><p><?php print_string('backtotop', 'theme_defaultlms'); ?></p></a>
...
<!--[if lte IE 9]>
<script src="<?php echo $CFG->wwwroot;?>/theme/defaultlms/javascript/ie/matchMedia.js"></script>
<![endif]-->
